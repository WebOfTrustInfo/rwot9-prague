...
![alt_text](media/ReputationInterpretation0.jpg "image_tooltip")
...
![alt_text](media/ReputationInterpretation1.jpg "image_tooltip")
...
*   **Concerns**: Once the data is normalized, the specific concerns are applied to the data. The judgements are individual for each community or system. For example, Bob may think study of Jungian psychology is an advantage or a disadvantage for the health clinic.  
    *   **Weights** signify The importance of each element of data is (for example, peer reviews are 30% of Alice’s score).
...
*   Choose from options (scheduled an interview or session, purchase a subscription, buy a book or online course Alice has published)
